...
// Pricing — Individual is the recommended plan: solid teal fill, cream text,
// so it reads as the plan to pick (founder call 2026-08-24). Enterprise stays
// quiet/contact-us. Corrected pricing: 14-day free trial (no card), $20/mo or
// $168/yr ($14/mo, ~30% off) — replaces the stale "30 days free / $19.99".
//
    ...
    <>
      ...
      >
        <div style={{ width: "100%", maxWidth: 880, display: "flex", flexDirection: "column", alignItems: "center" }}>
          <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.18em", color: "var(--pp-teal)", textTransform: "uppercase", marginBottom: 14 }}>
            Pricing
          </div>

          <h1
            className="font-serif-display"
            style={{ fontWeight: 500, fontSize: "clamp(38px, 4.6vw, 56px)", lineHeight: 1.08, letterSpacing: "-0.015em", margin: "0 0 18px", textAlign: "center", maxWidth: 640, textWrap: "balance", color: "var(--pp-ink)" }}
          >
            Try Ontor free for <em style={{ fontStyle: "italic", color: "var(--pp-teal)" }}>14 days</em>
          </h1>

          <p style={{ color: "var(--pp-ink-soft)", fontSize: 18, margin: "0 0 48px", textAlign: "center", maxWidth: 520 }}>
          ...
          >
            ...
            <div style={{ background: "linear-gradient(165deg, #0F766E 0%, #0B5048 100%)", color: cream, borderRadius: 18, padding: "34px 32px 30px", display: "flex", flexDirection: "column", boxShadow: "0 22px 46px rgba(11,80,72,.32)" }}>
              ...
              <div style={{ fontSize: 14, fontWeight: 600, color: "rgba(251,248,241,.85)", marginBottom: 12 }}>Everything you need to read your own voice:</div>
              <div style={{ display: "flex", flexDirection: "column", gap: 11, fontSize: 15.5 }}>
                <div style={{ display: "flex", gap: 10, alignItems: "baseline" }}><Check color={amber} /><span>Near real-time voice analysis as you speak</span></div>
                <div style={{ display: "flex", gap: 10, alignItems: "baseline" }}><Check color={amber} /><span>Your baseline and your usual range</span></div>
                <div style={{ display: "flex", gap: 10, alignItems: "baseline" }}><Check color={amber} /><span>Only your voice is measured, not the room</span></div>
                <div style={{ display: "flex", gap: 10, alignItems: "baseline" }}><Check color={amber} /><span>Session history you can look back on</span></div>
                <div style={{ display: "flex", gap: 10, alignItems: "baseline" }}>
                  <Check color={amber} />
                  <span style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                    Pattern analysis across your week
                    <span style={{ background: "rgba(251,248,241,.14)", border: "1px solid rgba(251,248,241,.35)", color: cream, fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", borderRadius: 999, padding: "1px 9px" }}>Coming</span>
                  </span>
                </div>
              </div>
            </div>

            {/* Enterprise — quiet, contact-us */}
            <div style={{ background: "var(--pp-card)", border: "1px solid var(--pp-line)", borderRadius: 18, padding: "34px 32px 30px", display: "flex", flexDirection: "column" }}>
              ...
              <a href="#" className="price-btn-ghost" style={{ display: "block", textAlign: "center", background: "transparent", color: "var(--pp-teal)", fontWeight: 600, fontSize: 16, border: "1px solid var(--pp-line-strong)", borderRadius: 12, padding: "12px 20px", marginTop: 24, textDecoration: "none" }}>Contact us</a>
              <div style={{ textAlign: "center", fontSize: 13, color: "var(--pp-ink-soft)", marginTop: 10 }}>We&rsquo;ll tailor it to your team</div>
              <div style={{ height: 1, background: "var(--pp-line)", margin: "22px 0 18px" }} />
              <div style={{ fontSize: 14, fontWeight: 600, color: "var(--pp-ink-soft)", marginBottom: 12 }}>Everything in Individual, plus:</div>
              <div style={{ display: "flex", flexDirection: "column", gap: 11, fontSize: 15.5, color: "var(--pp-ink)" }}>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap", justifyContent: "center", marginTop: 40, color: "var(--pp-ink-soft)", fontSize: 14.5 }}>
        ...
        <style>{`
          .pricing-page {
            --pp-paper: #FFFFFF; --pp-card: #FFFFFF; --pp-ink: #1B1A17; --pp-ink-soft: #5A554B;
