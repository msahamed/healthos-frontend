...
// token in the body. The browser never touches the token in JS. Web sessions
// expire after 7 idle days or 30 total days; installed-app sessions are longer.
//
...
// they sign in here.
//
// Already signed in? app/login/page.tsx validates the cookie and redirects to
// the sanitized `next` destination before this client component renders.
//
