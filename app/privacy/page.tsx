  ...
  return (<>
    ...
    <main>
      <header className={styles.hero}><div className={styles.heroInner}>
        ...
        <p className={styles.updated}>Last updated: August 17, 2026</p>
      </div></header>
      <div className={styles.pageShell}>
        ...
        <article className={styles.policy}>
          ...
          <section className={styles.policySection} id="analytics"><p className={styles.sectionNumber}>05</p><h2>Analytics and tracking</h2><p>Ontor sends usage and reliability data, such as which screens you open, when a check-in completes, and crash reports, to Ontor&apos;s own servers, tied to a randomly generated device identifier. This is independent of sync and happens whether or not sync is on. This identifier is not linked to your name, and we do not combine it with data from other companies.</p><p>For research purposes, Ontor may use aggregated, anonymized data. Ontor does not use advertising identifiers or third-party advertising SDKs, and does not sell your data.</p></section>
